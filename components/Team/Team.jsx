        ...
        <div className="memberCard bg-bglight rounded-t-md rounded-l-md rounded-b-none flex flex-col mx-auto">
          ...
          <span className="memberName mb-1">Shihab Shahriar Rashu</span>
            ...
            <div className="memberDesc">
              ...
              <ul className="memberLinks flex">
                <li className="text-4xl mx-auto mb-4 mt-8"><a href="https://facebook.com/mdshihabshahriar.rashu" target="_blank"><FaGlobe /></a></li>
                <li className="text-4xl mx-auto mb-4 mt-8"><a href="https://github.com/muhammadshihab" target="_blank"><FaGithub /></a></li>
                <li className="text-4xl mx-auto mb-4 mt-8"><a href="https://youtube.com/" target="_blank"><FaYoutube /></a></li>
                <li className="text-4xl mx-auto mb-4 mt-8"><a href="https://www.linkedin.com/" target="_blank"><FaLinkedin /></a></li>
              </ul>
            </div>
          </div>
        </div>
